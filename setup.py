...
plugin_identifier = "m600_filament_change"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_m600_filament_change"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-M600_filament_change"
...
# module
plugin_description = """Use M600 added in Cura for Filament Change in a Snapmaker"""
